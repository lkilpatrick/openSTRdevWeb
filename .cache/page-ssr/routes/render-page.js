...
"use client"
;function i(){return i=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},i.apply(this,arguments)}function a(t){let e=t||"/",n="",r="";const o=e.indexOf("#");-1!==o&&(r=e.slice(o),e=e.slice(0,o));const s=e.indexOf("?");return-1!==s&&(n=e.slice(s),e=e.slice(0,s)),{pathname:e,search:"?"===n?"":n,hash:"#"===r?"":r}}const c=/^[a-zA-Z][a-zA-Z\d+\-.]*?:/,l=t=>{if("string"==typeof t)return!(t=>c.test(t))(t)},p=()=> false?0:"",h=()=> false?0:"";function f(t,e=p()){var n;if(!l(t))return t;if(t.startsWith("./")||t.startsWith("../"))return t;const r=null!=(n=null!=e?e:h())?n:"/";return`${null!=r&&r.endsWith("/")?r.slice(0,-1):r}${t.startsWith("/")?t:`/${t}`}`}const u=t=>null==t?void 0:t.startsWith("/"),_=()=> true?"always":0;function d(t,e){const{pathname:n,search:r,hash:o}=a(t);return`${(0,apply_trailing_slash_option/* applyTrailingSlashOption */.T)(n,e)}${r}${o}`}const m=(t,e)=>"number"==typeof t?t:l(t)?u(t)?function(t){const e=f(t),n=_();return"always"===n||"never"===n?d(e,n):e}(t):function(t,e){if(u(t))return t;const r=_(),o=(0,index_modern.resolve)(t,e);return"always"===r||"never"===r?d(o,r):o}(t,e):t,y=["to","getProps","onClick","onMouseEnter","activeClassName","activeStyle","innerRef","partiallyActive","state","replace","_location"];function v(t){return f(t,h())}const b={activeClassName:prop_types.string,activeStyle:prop_types.object,partiallyActive:prop_types.bool};function w(t){/*#__PURE__*/return external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.createElement(index_modern.Location,null,({location:n})=>/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.createElement(P,i({},t,{_location:n})))}class P extends external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.Component{constructor(t){super(t),this.defaultGetProps=({isPartiallyCurrent:t,isCurrent:e})=>(this.props.partiallyActive?t:e)?{className:[this.props.className,this.props.activeClassName].filter(Boolean).join(" "),style:i({},this.props.style,this.props.activeStyle)}:null;let e=!1;"undefined"!=typeof window&&window.IntersectionObserver&&(e=!0),this.state={IOSupported:e},this.abortPrefetch=null,this.handleRef=this.handleRef.bind(this)}_prefetch(){let t=window.location.pathname+window.location.search;this.props._location&&this.props._location.pathname&&(t=this.props._location.pathname+this.props._location.search);const e=a(m(this.props.to,t)),n=e.pathname+e.search;if(t!==n)return ___loader.enqueue(n)}componentWillUnmount(){if(!this.io)return;const{instance:t,el:e}=this.io;this.abortPrefetch&&this.abortPrefetch.abort(),t.unobserve(e),t.disconnect()}handleRef(t){this.props.innerRef&&Object.prototype.hasOwnProperty.call(this.props.innerRef,"current")?this.props.innerRef.current=t:this.props.innerRef&&this.props.innerRef(t),this.state.IOSupported&&t&&(this.io=((t,e)=>{const n=new window.IntersectionObserver(n=>{n.forEach(n=>{t===n.target&&e(n.isIntersecting||n.intersectionRatio>0)})});return n.observe(t),{instance:n,el:t}})(t,t=>{t?this.abortPrefetch=this._prefetch():this.abortPrefetch&&this.abortPrefetch.abort()}))}render(){const t=this.props,{to:n,getProps:r=this.defaultGetProps,onClick:s,onMouseEnter:c,state:p,replace:h,_location:f}=t,u=function(t,e){if(null==t)return{};var n,r,o={},s=Object.keys(t);for(r=0;r<s.length;r++)e.indexOf(n=s[r])>=0||(o[n]=t[n]);return o}(t,y); true||0;const _=m(n,f.pathname);return l(_)?/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.createElement(index_modern.Link,i({to:_,state:p,getProps:r,innerRef:this.handleRef,onMouseEnter:t=>{c&&c(t);const e=a(_);___loader.hovering(e.pathname+e.search)},onClick:t=>{if(s&&s(t),!(0!==t.button||this.props.target||t.defaultPrevented||t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)){t.preventDefault();let e=h;const n=encodeURI(_)===f.pathname;"boolean"!=typeof h&&n&&(e=!0),window.___navigate(_,{state:p,replace:e})}return!0}},u)):/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.createElement("a",i({href:_},u))}}P.propTypes=i({},b,{onClick:prop_types.func,to:prop_types.string.isRequired,replace:prop_types.bool,state:prop_types.object});const E=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.forwardRef((t,n)=>/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.createElement(w,i({innerRef:n},t))),g=(t,e)=>{window.___navigate(m(t,window.location.pathname),e)};
//# sourceMappingURL=index.modern.mjs.map

;// ./.cache/context-utils.js
// Ensure serverContext is not created more than once as React will throw when creating it more than once
// https://github.com/facebook/react/blob/dd2d6522754f52c70d02c51db25eb7cbd5d1c8eb/packages/react/src/ReactServerContext.js#L101
const createServerContext=(name,defaultValue=null)=>{/* eslint-disable no-undef */if(!globalThis.__SERVER_CONTEXT){globalThis.__SERVER_CONTEXT={};}if(!globalThis.__SERVER_CONTEXT[name]){globalThis.__SERVER_CONTEXT[name]=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createServerContext(name,defaultValue);}return globalThis.__SERVER_CONTEXT[name];};function createServerOrClientContext(name,defaultValue){if((external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default()).createServerContext){return createServerContext(name,defaultValue);}return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createContext(defaultValue);}
;// ./.cache/static-query.js
const StaticQueryContext=createServerOrClientContext(`StaticQuery`,{});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement((external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}let warnedAboutStaticQuery=false;// TODO(v6): Remove completely
const StaticQuery=props=>{const{data,query,render,children}=props;if(false){}return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};StaticQuery.propTypes={data:(prop_types_default()).object,query:(prop_types_default()).string.isRequired,render:(prop_types_default()).func,children:(prop_types_default()).func};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
if((external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default()).captureOwnerStack){// React 19+ approach
const ownerStack=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().captureOwnerStack();const currentStack=new Error().stack||``;fullStack=ownerStack?`${currentStack}\n${ownerStack}`:currentStack;}else if((_React$__SECRET_INTER=(external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default()).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED)!==null&&_React$__SECRET_INTER!==void 0&&(_React$__SECRET_INTER2=_React$__SECRET_INTER.ReactDebugCurrentFrame)!==null&&_React$__SECRET_INTER2!==void 0&&_React$__SECRET_INTER2.getCurrentStack){// React 18 approach
fullStack=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();}else{// Fallback if neither API is available
...
"use strict";
module.exports = require("C:\\developer\\openSTRdevWeb-1\\node_modules\\react\\index.js");
...
var _react = _interopRequireDefault(__webpack_require__(223));
...
var React = _interopRequireWildcard(__webpack_require__(223));
...
exports.components={"component---src-pages-about-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-about-tsx */ 970).then(__webpack_require__.bind(__webpack_require__, 4748)),"component---src-pages-contribute-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-contribute-tsx */ 806).then(__webpack_require__.bind(__webpack_require__, 9222)),"component---src-pages-faq-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-faq-tsx */ 925).then(__webpack_require__.bind(__webpack_require__, 1875)),"component---src-pages-index-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-tsx */ 245).then(__webpack_require__.bind(__webpack_require__, 6022)),"component---src-pages-why-openstr-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-why-openstr-tsx */ 965).then(__webpack_require__.bind(__webpack_require__, 7623))};
...
const IsHeadRenderContext=/*#__PURE__*/external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().createContext(false);function getValidHeadComponentReplacements(originalCreateElement,forceHeadRenderContext){function useIsHeadRender(){if(forceHeadRenderContext){// for SSR we don't need to use React context, because head rendering is sync
...
const isHeadRenderFromContext=external_C_developer_openSTRdevWeb_1_node_modules_react_index_js_default().useContext(IsHeadRenderContext);return isHeadRenderFromContext;}function htmlOrBodyComponentFactory(TagName){const HeadAwareComponent=props=>{// De-risk monkey patch by only applying it within a `Head()` render.
...
const React=__webpack_require__(223);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(3304);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(3985);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
module.exports = require("C:\\developer\\openSTRdevWeb-1\\.cache\\ssr-builtin-trackers\\fs");
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + ({"245":"component---src-pages-index-tsx","806":"component---src-pages-contribute-tsx","925":"component---src-pages-faq-tsx","965":"component---src-pages-why-openstr-tsx","970":"component---src-pages-about-tsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(223);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(3985);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(8370);const{WritableAsPromise}=__webpack_require__(5297);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(8227);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
